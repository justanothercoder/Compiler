...
{
    return member -> getSymbolType() == SymbolType::VARIABLE ? static_cast<VariableSymbol*>(member) -> getType() : VariableType(static_cast<OverloadedFunctionSymbol*>(member), true);
}
