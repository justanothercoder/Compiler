...
void FunctionSymbol::define(Symbol *sym)
{
	...
	{
	    addresses[static_cast<VariableSymbol*>(sym)] = scope_size + BuiltIns::int_size;
...
void FunctionSymbol::recalc_scope_address() { scope_address = enclosing_scope->getScopeAddress() + enclosing_scope->getScopeSize() + BuiltIns::int_size; }
...
int FunctionSymbol::getSize() const { return BuiltIns::int_size; }
