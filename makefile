...
SOURCES=main.cpp token.cpp abstractlexer.cpp lexer.cpp abstractparser.cpp parser.cpp ast.cpp declarationnode.cpp structdeclarationnode.cpp \
	   	...
	   	semanticerror.cpp typeinfo.cpp symbol.cpp returnnode.cpp ifnode.cpp definetypesvisitor.cpp \
		...
		modulenode.cpp functionnode.cpp modulesymbol.cpp modulememberaccessnode.cpp comp.cpp compilableunit.cpp \
