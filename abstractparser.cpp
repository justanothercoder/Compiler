...
AbstractParser::AbstractParser(AbstractLexer *input) : input(input), pos(-1) { consume(); } 
...
TokenType AbstractParser::getTokenType(int i) { return getToken(i).type; }
...
void AbstractParser::seek(int i) { pos = i; }

bool AbstractParser::isSpeculating() { return markers.size() > 0; }
