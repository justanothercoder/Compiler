...
public:
    ...
    virtual const Symbol*           resolveMember(std::string name) const = 0;
    virtual const FunctionalSymbol* resolveMethod(std::string name, const FunctionTypeInfo& info) const = 0;
